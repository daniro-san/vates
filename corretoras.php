  ...
  <body class="dashboard-5">
    ...
    <div class="slim-mainpanel">
      <div class="container pd-t-10">
        <div class="row">
          <div class="col-4">
            <h3 class="text-dark">CORRETORAS</h3 class="text-dark">
            <p class="mg-b-20 mg-sm-b-40"></p>
          </div>
          <div class="col-8">
            <button class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp; Nova Corretora</button>
          </div>
        </div>
        <div class="row mb-3 d-none">
          <div class="col-4">
            ...
            <select type="text" name="teste" class="form-control" id="">
              ...
              <option value="V">ESTADUAL</option>
              <option value="P">INTERNO</option>
              <option value="P">EXTERNO</option>
            </select>
          </div>
          <div class="col-8">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered mg-b-0">
            <thead class="thead-colored bg-info">
              <tr>
                <th>NOME</th>
                <th>LINHA CRÉDITO IM (US$)</th>
                <th>LINHA CRÉDITO VM (US$)</th>
                <th>CASH (US$)</th>
                <th>JUROS (%)</th>
              </tr>
            </thead>
