  ...
  <body class="dashboard-5">
    ...
    <div class="slim-mainpanel">
      <div class="container pd-t-10">
        <div class="row">
          <div class="col-4">
            <h3 class="text-dark">PRODUÇÃO/VENDA</h3 class="text-dark">
            <p class="mg-b-20 mg-sm-b-40"></p>
          </div>
          <div class="col-8">
            <button class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp; Nova Venda</button>
          </div>
        </div>
        <div class="row mb-3">
          <div class="col-lg">
            <label>VENDA/PRODUÇÃO</label>
          ...
          <div class="col-lg">
            ...
            <select type="text" name="teste" class="form-control" id="">
              ...
              <option value="V">João Quadros</option>
              <option value="P">Maria da Silva</option>
            </select>
          </div>
          <div class="col-lg">
            <button class="btn btn-primary btn-block rounded-30 mg-t-30"><i class="fa fa-search"></i>&nbsp; PESQUISAR</button>
          </div>
        </div>
          ...
          <table class="table table-striped table-bordered mg-b-0">
            <thead class="thead-colored bg-info">
              <tr>
                ...
                <th>TÉRMINO</th>
                <th>COND. FIXAÇÃO</th>
                <th>VOLUME TOTAL (TN)</th>
                <th>PRÊMIO (U$/TONELADA)</th>
