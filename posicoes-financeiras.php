  ...
  <body class="dashboard-5">
    ...
    <div class="slim-mainpanel">
      <div class="container pd-t-10">
        <div class="row">
          <div class="col-4">
            <h3 class="text-dark">POSIÇÕES FINANCEIRAS</h3 class="text-dark">
            <p class="mg-b-20 mg-sm-b-40"></p>
          </div>
          <div class="col-8">
            <button class="btn btn-primary float-right"><i class="fa fa-plus"></i>&nbsp; Nova Posição</button>
          </div>
        </div>
        <div class="row mb-2">
          <div class="col-lg">
            <label>FÍSICO/CÂMBIO</label>
            <select type="text" name="teste" class="form-control" id="">
          ...
          <div class="col-lg">
            ...
            <select type="text" name="teste" class="form-control" id="">
              ...
              <option value="">NY#11</option>
              <option value="">NY#12</option>
              <option value="">NY#13</option>
              <option value="">NY#14</option>
            </select>
          </div>
          <div class="col-lg">
            <label>MÊS</label>
          ...
          <div class="col-lg">
            ...
            <select type="text" name="teste" class="form-control" id="">
              <option value="*">Todos</option>
              <option value="V">2018</option>
              <option value="P">2017</option>
              <option value="P">2016</option>
        ...
        <div class="row">
          <div class="col-lg">
            ...
            <select type="text" name="teste" class="form-control" id="">
              <option value="*">Todos</option>
              <option value="V">TELA1</option>
              <option value="P">TELA2</option>
              <option value="P">TELA3</option>
              <option value="P">TELA4</option>
            </select>
          </div>
          <div class="col-lg">
            ...
            <select type="text" name="teste" class="form-control" id="">
              <option value="*">Todas</option>
              <option value="V">ED&F Man Capital Markets</option>
              <option value="P">Corretora 1</option>
              <option value="P">Corretora 2</option>
              <option value="P">Corretora 3</option>
            </select>
          </div>
          <div class="col-lg">
            <label>INSTRUMENTO DERIVATIVO</label>
            <select type="text" name="teste" class="form-control" id="">
              <option value="*">Todos</option>
              <option value="V">FUTURO</option>
              <option value="P">PUT</option>
              <option value="P">CALL</option>
            </select>
          </div>
          <div class="col-lg">
            <label>POSIÇÃO</label>
            <select type="text" name="teste" class="form-control" id="">
              ...
              <option value="P">VENDA</option>
            </select>
          </div>
        </div>
        <div class="row mb-3">
          <div class="col-lg">
            <button class="btn btn-primary btn-block rounded-30 mg-t-15"><i class="fa fa-search"></i>&nbsp; PESQUISAR</button>
          </div>
        </div>
