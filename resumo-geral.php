  ...
  <body class="dashboard-5">
    ...
    <div class="slim-mainpanel">
      <div class="container pd-t-10">
        <div class="row">
          <div class="col-4">
            <h3 class="text-dark">RESUMO GERAL</h3 class="text-dark">
        ...
        <div class="row row-sm">
          <div class="col-6">
            <div class="card card-popular-product">
              ...
              <h5 class="prod-name"><a href="">VOLATILIDADE</a></h5>
          ...
          <div class="col-6">
            <div class="card card-popular-product">
              ...
              <h5 class="prod-name"><a href="">VAR</a></h5>
              <!-- <p class="prod-by">By: <a href="">ThmPxls Security</a></p> -->
              <div class="row">
                <div class="col-6">
                  <h1>834.85K</h1>
                  <p>HIBRÍDO DA EXPOSIÇÃO</p>
                </div><!-- col -->
                <div class="col-6">
                  <h1>-</h1>
                  <p>CHAMADA DE MARGEM</p>
                </div><!-- col -->
              </div><!-- row -->
            </div><!-- card -->
          </div><!-- col-4 -->
